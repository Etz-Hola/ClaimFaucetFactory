...
contract ClaimFaucet is DltToken{
    ...
    constructor(string memory _name, string memory _symbo) DltToken(_name, _symbo){}
    ...
    function claimToken(address _address) public  {
        ...
        if(hasClaimedBefore[_address]){
            ...
            require(currentUser.lastClaimTime + 1 days >= block.timestamp, "you can claim after 24 hours");
